...
async def maintenance_mode_middleware(request: Request, call_next):
    ...
    if maintenance_state.is_enabled():
        ...
        return JSONResponse(
            status_code=status.HTTP_503_SERVICE_UNAVAILABLE, content={"detail": maintenance_state.get_message(), "status": "maintenance", "retry_after": 3600}, headers={"Retry-After": "3600"}
        )
